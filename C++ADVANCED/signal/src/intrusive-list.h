...
class list_element : protected list_element_base {
private:
...
public:
  ...
  // O(1) added for signal
  iterator get_iterator(T& value) noexcept {
    return iterator(&value);
  }

  // O(1) added for signal
  const_iterator get_iterator(T& value) const noexcept {
